...
function AuthPage() {
  ...
  return (
    <div className="min-h-screen lg:h-screen lg:min-h-0 lg:overflow-hidden bg-background relative lg:grid lg:grid-cols-[1.1fr_1fr]">
      ...
      {whatsEnabled && supportWhats && (
        <a
          href={`https://wa.me/${supportWhats.replace(/\D/g, "")}?text=${encodeURIComponent("Olá! Preciso de ajuda para acessar o Zappfy.")}`}
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Falar com o suporte no WhatsApp"
          className="fixed bottom-5 right-5 z-30 grid place-items-center h-14 w-14 rounded-full bg-[#25D366] text-white shadow-[0_10px_30px_-5px_rgba(37,211,102,0.55)] hover:shadow-[0_0_30px_2px_rgba(37,211,102,0.7)] transition-all hover:-translate-y-0.5"
        >
          <span className="absolute inset-0 rounded-full bg-[#25D366]/40 blur-md opacity-70 animate-pulse -z-10" />
