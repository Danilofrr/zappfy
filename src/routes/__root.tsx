...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ZappFy — Gestão para vendas no WhatsApp" },
      { name: "description", content: "Controle pedidos, vendas, despesas e lucro real do seu negócio." },
      { name: "author", content: "ZappFy" },
      { name: "theme-color", content: "#10b981" },
      { name: "application-name", content: "ZappFy" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "ZappFy" },
      { name: "format-detection", content: "telephone=no" },
      { property: "og:title", content: "ZappFy — Gestão para vendas no WhatsApp" },
      { property: "og:description", content: "Controle pedidos, vendas, despesas e lucro real do seu negócio." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "ZappFy — Gestão para vendas no WhatsApp" },
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", sizes: "192x192", href: "/dashboard-icon-192.png" },
      { rel: "icon", type: "image/png", sizes: "512x512", href: "/dashboard-icon-512.png" },
      { rel: "apple-touch-icon", sizes: "180x180", href: "/dashboard-apple-touch-icon.png" },
    ],
  }),
