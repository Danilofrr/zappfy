...
ALTER TABLE public.delivery_tracking_settings
  ADD COLUMN IF NOT EXISTS card_border_color text NOT NULL DEFAULT '#1e293b',
  ADD COLUMN IF NOT EXISTS title_color text NOT NULL DEFAULT '#ffffff',
  ADD COLUMN IF NOT EXISTS status_color text NOT NULL DEFAULT '#10b981',
  ADD COLUMN IF NOT EXISTS card_opacity numeric NOT NULL DEFAULT 1,
  ADD COLUMN IF NOT EXISTS card_glass boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS card_shadow text NOT NULL DEFAULT 'md',
  ADD COLUMN IF NOT EXISTS border_intensity numeric NOT NULL DEFAULT 1;
