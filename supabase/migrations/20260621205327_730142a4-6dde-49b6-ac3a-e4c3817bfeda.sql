...
ALTER TABLE public.delivery_tracking_settings
  ADD COLUMN IF NOT EXISTS courier_header_height integer DEFAULT 110,
  ADD COLUMN IF NOT EXISTS courier_header_logo_size integer DEFAULT 56,
  ADD COLUMN IF NOT EXISTS courier_header_logo_align text DEFAULT 'center';
